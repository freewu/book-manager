...
EN = dict(
    ...
    shot_prev="Previous screenshot",
    shot_next="Next screenshot",
    lang_label="Language",
    readme_link="README",
    ...
    known_title="Known issue (Windows only): blank window (WebView2 stops repainting)",
...
ZH_CN = dict(
    name="Book Manager",
    title="Book Manager · 本地电子书管理（Windows / macOS / Linux）",
    ...
    data_title="数据存储",
    known_title="已知问题（仅 Windows）：白屏（WebView2 不重绘）",
    version_title="版本号",
...
ZH_TW = dict(
    name="Book Manager",
    title="Book Manager · 本機電子書管理（Windows / macOS / Linux）",
    ...
    data_title="資料儲存",
    known_title="已知問題（僅 Windows）：白畫面（WebView2 不重繪）",
    version_title="版本號",
